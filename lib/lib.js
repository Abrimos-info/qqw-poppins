...
function redirectToLanguage(es,en) {
  return catchError(async function(req, res, next) {
    ...
    console.log("redirectToLanguage DEBUG - req.url:", req.url, "req.originalUrl:", req.originalUrl, "req.baseUrl:", req.baseUrl, "basePath:", basePath, "current_url:", current_url);
