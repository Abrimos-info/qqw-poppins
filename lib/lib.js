...
function redirectToLanguage(es,en) {
  return catchError(async function(req, res, next) {
    ...
    // Get host from headers, with fallback
    ...
    // Log for debugging
    console.log('redirectToLanguage - host:', host, 'x-forwarded-host:', req.headers['x-forwarded-host'], 'host header:', req.headers.host);
